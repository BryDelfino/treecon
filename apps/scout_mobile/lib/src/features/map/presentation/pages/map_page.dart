...
class _MapPageState extends State<MapPage> with SingleTickerProviderStateMixin {
  ...
  final List<String> _availableSeverities = ['All', 'Healthy', 'Low', 'Moderate', 'High', 'Critical'];
  String _selectedPlantationGri = 'All';
  final List<String> _availableGriClasses = ['All', 'Rare', 'Occasional', 'Common', 'Very Common', 'Widespread'];
